...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etItemText.setText(getIntent().getStringExtra(TodoActivity.ITEM_TEXT));
    ...
    public void onSaveItem(View v) {
        ...
        data.putExtra(TodoActivity.ITEM_TEXT, etItemText.getText().toString());
        data.putExtra(TodoActivity.ITEM_POSITION, position); // ints work too
